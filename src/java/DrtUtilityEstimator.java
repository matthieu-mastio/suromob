...
public class DrtUtilityEstimator implements UtilityEstimator {
    ...
    protected double estimateRejectionUtility(DrtVariables variables) {
        return this.modeParameters.drt.betaRejection_u * variables.rejectionProbability;
    }
    ...
    public double estimateUtility(Person person, DiscreteModeChoiceTrip trip, List<? extends PlanElement> elements) {
        ...
        utility += estimateRejectionUtility(variables);
        return utility;
    }
}
