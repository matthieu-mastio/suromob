...
import org.eqasim.core.simulation.modes.drt.mode_choice.predictors.DrtFeedbackService;
...
public class EqasimModeChoiceModule extends AbstractEqasimExtension {
	...
	protected void installEqasimExtension() {
		...
		bind(DrtFeedbackService.class).in(Singleton.class);
		addEventHandlerBinding().to(DrtFeedbackService.class);
		addControlerListenerBinding().to(DrtFeedbackService.class);
	...
	public DefaultDrtPredictor provideDefaultDrtPredictor(Config config, Map<String, Provider<CostModel>> factory,
			DrtFeedbackService feedbackService) {
