...
import org.eqasim.ile_de_france.mode_choice.costs.FlatDrtCostModel;
...
public class IDFModeChoiceModule extends AbstractEqasimExtension {
	...
	public static final String DRT_COST_MODEL_NAME = "FlatDrtCostModel";
	...
	protected void installEqasimExtension() {
		...
		bindCostModel(DRT_COST_MODEL_NAME).to(FlatDrtCostModel.class);
